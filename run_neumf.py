...
def train_neumf(train_df, val_df, num_users, num_items, latent_dim_mf=16, latent_dim_mlp=32, mlp_layers=[64, 32, 16, 8], dropout=0.4, epochs=20, batch_size=256, lr=0.001):
...
def run_neumf(df, time_based=False):
    ...
    if time_based:
        ...
        model, train_losses, val_losses, val_rmse, val_mae = train_neumf(train_df, val_df, num_users, num_items)
