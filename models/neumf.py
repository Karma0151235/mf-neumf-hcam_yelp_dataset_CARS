...
class MLP(nn.Module):
    def __init__(self, num_users, num_items, layers=[64, 32, 16, 8], dropout=0.2, init_std=0.01):
...
class NeuMF(nn.Module):
    def __init__(self, num_users, num_items, latent_dim_mf=16, latent_dim_mlp=32, mlp_layers=[64, 32, 16, 8], dropout=0.2, init_std=0.01):
