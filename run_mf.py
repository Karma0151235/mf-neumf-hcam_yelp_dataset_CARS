...
# TRAINING WITHOUT EARLY STOPPING (faithful to Unger et al.)
...
def train_mf(train_df, val_df, num_users, num_items, latent_dim=32, epochs=20, batch_size=128, lr=0.02):
    ...
    train_data = TensorDataset(users_train, items_train, ratings_train)
    val_data = TensorDataset(users_val, items_val, ratings_val)
...
if __name__ == '__main__':
    ...
    for seed in range(10):
        ...
        model = train_mf(train_df, val_df, num_users, num_items)
